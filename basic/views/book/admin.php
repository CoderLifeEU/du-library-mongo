...
$this->registerJsFile('@web/js/book/admin.js',['depends' => [\yii\web\JqueryAsset::className()]]);
?>
<style>
    #example_filter{
        display:none;
...
<div class="site-index">
    <input class="hidden" type="text" id="token" value="<?php           Yii::$app->user->identity->token ?>" />
    <div class="jumbotron">
        <h1>Hello from Administrate books</h1>

        <p class="lead">Administrate books</p>
